...
namespace CompanyNotes.Controllers
{
    public class SubcontractorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubcontractorId,Name,Address,Email,Phone")] Subcontractor subcontractor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubcontractorId,Name,Address,Email,Phone")] Subcontractor subcontractor)
        {
            if (ModelState.IsValid)
            {
